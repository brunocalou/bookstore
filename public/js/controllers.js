var booksApp = angular.module('app', ['ngResource', 'filters']);
...
//Should add it to a filter file...
...
booksApp.filter('findbooks', function() {
  ...
  return function(books, text, category) {
    ...
    if (category == undefined) {
      ...
      category = removeDiacritics(category.toLowerCase());
    }
    ...
    for (var i = 0; i < books.length; i++) {
      var book = books[i],
        ...
        book_author = removeDiacritics(book.author.toLowerCase()),
